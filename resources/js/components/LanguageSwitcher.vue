<template>
    <div class="relative">
        <div class="d-inline-flex">{{ pilih }}</div>
        <button
                href="#"
        ...
        >
            ...
            <svg style="position:relative;top:15px;" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path class="heroicon-ui" d="M15.3 9.3a1 1 0 0 1 1.4 1.4l-4 4a1 1 0 0 1-1.4 0l-4-4a1 1 0 0 1 1.4-1.4l3.3 3.29 3.3-3.3z"></path></svg>
        </button>
...
<script>
    export default {
        props: ['locale', 'link-en', 'link-id', 'pilih'],
        data() {
            return {
                isVisible: false,
                focusedIndex: 0,
