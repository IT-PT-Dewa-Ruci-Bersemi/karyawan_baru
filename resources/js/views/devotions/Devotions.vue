<template>
    <div>
        <main>
            <section>
                <time v-for="devotion in devotions" :key="devotion.id">
                    <router-link :to="{name: 'devotionRead', params: {permalink:devotion.permalink} }">
                        <img :src="devotion.img_thumb_desktop">
                        <span class="caldate">{{ devotion.date_only }}</span>
                        <span class="title">{{ devotion.title }}</span>
                    </router-link>
                </time>
                ...
                <!--<time datetime="2015-08-02" class="hidden">-->
                    <!--<a href="http://thenewcode.com/1057/SVG-Patterns-of-Japan">-->
                        <!--<img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/4273/waves-thumb.png" alt="SVG Patterns of Japan" srcset="https://s3-us-west-2.amazonaws.com/s.cdpn.io/4273/waves-thumb.png 250w, https://s3-us-west-2.amazonaws.com/s.cdpn.io/4273/waves-2x-thumb.png 500w, https://s3-us-west-2.amazonaws.com/s.cdpn.io/4273/waves-2x.png 125w">-->
                        <!--<span class="caldate">02</span>-->
                        <!--<span class="title">SVG Patterns of Japan</span>-->
                    <!--</a>-->
                <!--</time>-->
                ...
                <!--<time datetime="2015-08-28" class="hidden">-->
                    <!--<a href="http://thenewcode.com/4/In-Other-Words-Using-the-blockquote-cite-and-q-elements"><img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/4273/bertrand-russell-thumb.jpg" alt="In Other Words: Using the blockquote, cite and q elements" srcset="https://s3-us-west-2.amazonaws.com/s.cdpn.io/4273/bertrand-russell-thumb.jpg 250w, https://s3-us-west-2.amazonaws.com/s.cdpn.io/4273/bertrand-russell-2x-thumb.jpg 500w, https://s3-us-west-2.amazonaws.com/s.cdpn.io/4273/bertrand-russell-2x-thumb.jpg 125w">-->
                        <!--<span-->
                                <!--class="caldate">28</span><span class="title">blockquote, cite and q-->
                        <!--</span>-->
                    <!--</a>-->
                <!--</time>-->
...
<script>
    export default {
        ...
        async mounted() {
            axios.get('./../api/get/devotions-list')
                .then(response=>{
                    this.devotions=response.data;
