<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="<?php echo e(route('admin_dashboard')); ?>">BETTA TOPAN</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?php echo e(route('admin_dashboard')); ?>"><img src="<?php echo e(asset('components/images/favicon_black.png')); ?>" width="35" /></a>
        </div>
...
</div><?php /**PATH /Users/echoinfinite/Documents/bootcamp/empty/app/Providers/../Modules/Admin/Views/templates/parts/menu.blade.php ENDPATH**/ ?>